...
<body class="bg-gradient-to-r from-blue-400 via-purple-600 to-blue-700">
    <div class="max-w-6xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        <div id="profile"
            ...
            <div class="p-4 md:p-12 text-center lg:text-left">
                ...
                <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"
                    style="background-image: url('https://images.unsplash.com/photo-1614741118887-7a4ee193a5fa?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=334&q=80')">
                </div>
                ...
                <div class="pt-12 pb-8">
                    <a href="{{ route('contact') }}" class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
                        Get In Touch
                    </a>
                </div>
                ...
                <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                    ...
                    <a class="link" href="https://twitter.com/TrojanCodes" data-tippy-content="@twitter_handle"><svg
                    ...
                    <a class="link" href="https://github.com.trojan782" data-tippy-content="@github_handle"><svg
                            class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <title>GitHub</title>
                            <path
        ...
        <div class="w-full lg:w-2/5">
            ...
            <img src="https://images.unsplash.com/photo-1614741118887-7a4ee193a5fa?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=334&q=80"
